        ...
        <div>
            <main className="max-w-3xl mx-auto px-4 py-6 md:py-8">
                <div className="flex items-center gap-3 mb-6 md:mb-8">
                    ...
                    <h1 className="text-xl md:text-2xl font-bold text-ink tracking-tight">New Category</h1>
                </div>
                ...
                <form onSubmit={handleSubmit} className="bg-surface border border-line rounded-2xl p-4 md:p-5 shadow-card space-y-5">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className="w-full bg-surface2 border border-line focus:border-accent/60 focus:bg-surface rounded-[10px] px-3 py-2 text-sm text-ink placeholder:text-inkmute outline-none transition-colors"
                    ...
                    <button
                        ...
                        className="w-full flex items-center justify-between gap-4 p-4 bg-surface2/50 rounded-xl border border-line hover:border-inkmute/30 transition-colors text-left focus-visible:ring-2 focus-visible:ring-accent/40 focus-visible:outline-none"
                    >
                        <div>

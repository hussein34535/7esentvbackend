    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-8">
            <div className="flex flex-wrap items-start justify-between gap-4 mb-6 md:mb-8">
                <div>
                    <h1 className="text-xl md:text-2xl font-bold text-gradient-brand tracking-tight">Goals</h1>
                ...
                <div className="flex gap-2">
                    <button
                        ...
                        className={`flex items-center gap-2 rounded-[10px] px-4 py-2 text-sm font-medium transition-all duration-200 active:scale-[0.98] shadow-sm focus-visible:ring-2 focus-visible:ring-violet-500/40 focus-visible:outline-none ${
                            selectMode
                                ? 'bg-violet-500/10 border border-violet-500/20 text-accentstrong'
                    ...
                    <Link
                        href="/goals/new"
                        className="flex items-center gap-2 btn-gradient-red text-white rounded-[10px] px-4 py-2 text-sm font-medium transition-all duration-200 active:scale-[0.98] shadow-sm focus-visible:ring-2 focus-visible:ring-violet-500/40 focus-visible:outline-none"
                    >
                ...
                <div className="flex flex-col sm:flex-row gap-3 mb-4">
                    <div className="relative flex-1">
                        ...
                        <input
                            ...
                            className="w-full bg-surface2 border border-line focus:border-violet-500/60 focus:bg-surface rounded-[10px] pl-9 pr-9 py-2 text-sm text-ink placeholder:text-inkmute outline-none transition-colors focus-visible:ring-2 focus-visible:ring-violet-500/40"
                        />
                        {query && (
                            <button
                                onClick={() => setQuery('')}
                                aria-label="Clear search"
                                className="absolute right-2 top-1/2 -translate-y-1/2 p-1.5 rounded-lg text-inkmute hover:text-ink hover:bg-surface transition-colors focus-visible:ring-2 focus-visible:ring-violet-500/40 focus-visible:outline-none"
                            >
                                <X className="w-4 h-4" />
                            </button>
                        )}
                    ...
                    <div className="relative sm:w-44">
                        <select
                            ...
                            className="w-full appearance-none bg-surface2 border border-line focus:border-violet-500/60 focus:bg-surface rounded-[10px] pl-3 pr-9 py-2 text-sm text-ink outline-none transition-colors cursor-pointer focus-visible:ring-2 focus-visible:ring-violet-500/40"
                        >
            ...
            {selectMode && (
                <div className="flex flex-wrap items-center gap-3 mb-4 p-3 bg-surface border border-line rounded-xl">
                    ...
                    <button
                        onClick={selectAll}
                        className="text-xs font-medium text-violet-500 hover:text-accentstrong px-2 py-1 rounded-lg hover:bg-violet-500/10 transition-colors focus-visible:ring-2 focus-visible:ring-violet-500/40 focus-visible:outline-none"
                    >
                        Select All
                    </button>
                    <button
                        onClick={deselectAll}
                        className="text-xs font-medium text-inksoft hover:text-ink px-2 py-1 rounded-lg hover:bg-surface2 transition-colors focus-visible:ring-2 focus-visible:ring-violet-500/40 focus-visible:outline-none"
                    >
                        Deselect All
                    </button>
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 bg-danger hover:bg-red-600 disabled:opacity-40 disabled:pointer-events-none text-white px-4 py-2 rounded-[10px] text-sm font-medium transition-all duration-200 active:scale-[0.98] shadow-sm focus-visible:ring-2 focus-visible:ring-violet-500/40 focus-visible:outline-none"
                    >
                            ...
                            <div key={goal.id} className="relative">
                                {selectMode && (
                                    <button
                                        ...
                                        className="absolute top-4 left-4 z-30 p-1 rounded-lg bg-surface/90 shadow-card transition-colors focus-visible:ring-2 focus-visible:ring-violet-500/40 focus-visible:outline-none"
                                    >
                                            ...
                                            {!selectMode && (
                                                <div className="flex gap-1">
                                                    <button
                                                        ...
                                                        className="p-2 rounded-lg text-inkmute hover:text-ink hover:bg-surface2 transition-colors z-20 relative focus-visible:ring-2 focus-visible:ring-violet-500/40 focus-visible:outline-none"
                                                    ...
                                                    <button
                                                        ...
                                                        className="p-2 rounded-lg text-inkmute hover:text-danger hover:bg-dangersoft transition-colors z-20 relative focus-visible:ring-2 focus-visible:ring-violet-500/40 focus-visible:outline-none"
                                                        title="Delete Goal"
                                                    >
                                                        <Trash2 className="w-4 h-4" />
                                                    </button>
            ...
            {!loading && goals.length === 0 && (
                <div className="text-center py-16 bg-surface border border-line rounded-2xl">
                    ...
                    <Link href="/goals/new" className="inline-flex items-center gap-2 mt-4 text-sm font-medium text-violet-500 hover:text-accentstrong transition-colors focus-visible:ring-2 focus-visible:ring-violet-500/40 focus-visible:outline-none rounded-lg px-2 py-1">
            ...
            {!loading && goals.length > 0 && displayed.length === 0 && (
                <div className="text-center py-16 bg-surface border border-line rounded-2xl">
                    ...
                    <button
                        onClick={() => setQuery('')}
                        className="mt-4 text-sm font-medium text-violet-500 hover:text-accentstrong transition-colors focus-visible:ring-2 focus-visible:ring-violet-500/40 focus-visible:outline-none rounded-lg px-2 py-1"
                    >
                        Clear search
                    </button>
                </div>

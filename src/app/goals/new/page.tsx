            ...
            <main className="max-w-3xl mx-auto px-4 py-6 md:py-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
                    ...
                    <section className="bg-surface border border-line rounded-2xl p-4 md:p-5 shadow-card space-y-3">
                        <div className="flex items-center justify-between">
                            ...
                            <button
                                type="button"
                                onClick={addLink}
                                className="inline-flex items-center gap-1 text-xs font-medium text-accentstrong bg-violet-500/10 hover:bg-accentline/70 px-3 py-1.5 rounded-full transition-colors focus-visible:ring-2 focus-visible:ring-violet-500/40 focus-visible:outline-none"
                            >
                                + Add Server
                            </button>
                        </div>
                            ...
                            <div key={idx} className="flex gap-2 items-start bg-surface2 border border-line p-3 rounded-xl">
                                <div className="flex-1 space-y-2">
                                    <input
                                        ...
                                        className="w-full bg-surface border border-line focus:border-violet-500/60 rounded-[10px] px-3 py-2 text-sm text-ink placeholder:text-inkmute outline-none transition-colors focus-visible:ring-2 focus-visible:ring-violet-500/40"
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className="w-full bg-surface border border-line focus:border-violet-500/60 rounded-[10px] pl-9 pr-3 py-2 text-sm text-ink placeholder:text-inkmute outline-none transition-colors font-mono focus-visible:ring-2 focus-visible:ring-violet-500/40"
                                ...
                                {links.length > 1 && (
                                    <button
                                        ...
                                        className="p-2 rounded-lg text-inkmute hover:text-danger hover:bg-dangersoft transition-colors focus-visible:ring-2 focus-visible:ring-violet-500/40 focus-visible:outline-none"
                                    >
                                        <X className="w-4 h-4" />
                                    </button>
                                )}
                    ...
                    <div className="pt-2 flex items-center justify-end gap-3">
                        <Link
                            href="/goals"
                            className="bg-surface border border-line hover:bg-surface2 text-ink rounded-[10px] px-4 py-2 text-sm font-medium transition-all duration-200 active:scale-[0.98] shadow-sm focus-visible:ring-2 focus-visible:ring-violet-500/40 focus-visible:outline-none"
                        >
                            Cancel
                        </Link>
                        <button

...
import { Save, ArrowLeft, Plus, Trash2, Star, Wand2 } from 'lucide-react';
        ...
        <div className="font-sans">
            <main className="max-w-3xl mx-auto px-4 py-4 md:py-8">
                <div className="flex items-center gap-4 mb-6 md:mb-8">
                    ...
                    <h1 className="text-xl md:text-2xl font-bold">Add New Match</h1>
                </div>

                <form onSubmit={handleSubmit} className="bg-slate-900 border border-slate-800 rounded-xl p-4 md:p-6 space-y-4 md:space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label className="block text-sm font-medium text-slate-400 mb-1">Time (UTC)</label>
                    ...
                    <div className="border-t border-slate-800 pt-6">
                        <div className="flex items-center justify-between mb-4">
                            <div>
                                ...
                                <p className="text-sm text-slate-500">Add multiple servers/qualities for this match.</p>
                            </div>

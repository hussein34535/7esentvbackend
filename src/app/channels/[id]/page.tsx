        ...
        <div>
            <main className="max-w-3xl mx-auto px-4 py-6 md:py-8">
                <div className="flex items-center gap-3 mb-6 md:mb-8">
                    ...
                    <h1 className="text-xl md:text-2xl font-bold text-ink tracking-tight">Edit Channel #{channelId}</h1>
                </div>
                    ...
                    <section className="bg-surface border border-line rounded-2xl p-4 md:p-5 shadow-card">
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                required
                                type="text"
                                className="w-full bg-surface2 border border-line focus:border-accent/60 focus:bg-surface rounded-[10px] pl-9 pr-3 py-2 text-sm text-ink outline-none transition-colors"
                            ...
                            {streams.map((stream, idx) => (
                                <div key={idx} className="group flex items-start gap-3 bg-surface2/50 p-3 md:p-4 rounded-xl border border-line hover:border-inkmute/30 transition-colors">
                                    ...
                                    <button
                                        ...
                                        className="mt-6 p-1.5 rounded-lg text-inkmute hover:text-danger hover:bg-dangersoft transition-colors focus-visible:ring-2 focus-visible:ring-accent/40 focus-visible:outline-none"
                                        title="Remove Stream"
                                    >
